...
# some more ls aliases
STUDY='/home/rushabh/'
SEM5='/home/rushabh/sem5'
WAUT20='/mnt/d/Courses/aut20'
WORK='/mnt/d/'
alias ll='ls -alF'
alias la='ls -A'
alias l='ls -CF'
alias stop_working="cd ~/ ; sudo umount /dev/sda2"
alias work="sudo mount /dev/sda2 /mnt/d"
alias fila_s5="study FILA && source .fila/bin/activate"
alias mars="java -jar ~/sem5/CA/labs/Mars4_5.jar"
function env(){
    temp_path="/home/rushabh/env"
    for i in "$@";
    do
...
function external_display(){
    sudo cat ~/.config/dontsleeponlidclose > /etc/systemd/logind.conf
    systemctl restart systemd-logind.service
}
function remove_external_display(){
    sudo cat ~/.config/sleeponlidclose > /etc/systemd/logind.conf
    systemctl restart systemd-logind.service
}
